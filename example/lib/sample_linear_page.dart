            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    // Text('Above', style: TextStyle(fontSize: 14)),
                    // SizedBox(height: 5),
                    Align(
                      alignment: Alignment.centerLeft,
                      child: SizedBox(
                        width:
                            200, // Adjust the width of the vertical progress bar
                        child: Transform.rotate(
                          angle:
                              -1.5708, // Rotate by 90 degrees counter-clockwise
                          child: LinearPercentIndicator(
                            lineHeight: 20,
                            center: Text('50%'),
                            linearGradient: LinearGradient(
                    ...
                    Align(
                      ...
                      child: SizedBox(
                        width:
                            200, // Adjust the width of the vertical progress bar
                        child: Text('4.5', style: TextStyle(fontSize: 14)),
                      ),
                    ),
                  ],
                ),
